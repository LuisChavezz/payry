...
class UserPermissionsRecord extends FirestoreRecord {
  ...
  // "read_branches" field.
  bool? _readBranches;
  bool get readBranches => _readBranches ?? false;
  bool hasReadBranches() => _readBranches != null;
  ...
  void _initializeFields() {
    ...
    _readBranches = snapshotData['read_branches'] as bool?;
  }
...
class UserPermissionsRecordDocumentEquality
  ...
  bool equals(UserPermissionsRecord? e1, UserPermissionsRecord? e2) {
    return e1?.uid == e2?.uid &&
        ...
        e1?.readBranches == e2?.readBranches;
  }
