...
class UsersRecord extends FirestoreRecord {
  ...
  // "is_valid_phone_number" field.
  bool? _isValidPhoneNumber;
  bool get isValidPhoneNumber => _isValidPhoneNumber ?? false;
  bool hasIsValidPhoneNumber() => _isValidPhoneNumber != null;
  ...
  // "is_company_complete" field.
  bool? _isCompanyComplete;
  bool get isCompanyComplete => _isCompanyComplete ?? false;
  bool hasIsCompanyComplete() => _isCompanyComplete != null;
  ...
  void _initializeFields() {
    ...
    _isValidPhoneNumber = snapshotData['is_valid_phone_number'] as bool?;
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    return e1?.email == e2?.email &&
        ...
        e1?.status == e2?.status &&
        e1?.isValidPhoneNumber == e2?.isValidPhoneNumber &&
