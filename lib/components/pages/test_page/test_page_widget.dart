    ...
    return StreamBuilder<List<RegistraCobroRecord>>(
      stream: queryRegistraCobroRecord(
        queryBuilder: (registraCobroRecord) => registraCobroRecord.where(
          'id',
          isEqualTo: 'tv4QOM7JNZUB1wXKM1hD',
        ),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<RegistraCobroRecord> testPageRegistraCobroRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final testPageRegistraCobroRecord =
            testPageRegistraCobroRecordList.isNotEmpty
                ? testPageRegistraCobroRecordList.first
                : null;
